package com.cynovo.kivvi.demo.function.outside.action.pinpad.pin.MKSK;
...
public class ActionGetPin extends BaseAction {
    ...
    public ActionGetPin(){
        super(GetString.getString(KivviApplication.getContext(),R.string.actionPinpad)+"|"+GetString.getString(KivviApplication.getContext(),R.string.loadkey_pin)+"|"+GetString.getString(KivviApplication.getContext(),R.string.MKSK)+"|"+GetString.getString(KivviApplication.getContext(),R.string.input_password)+"-3");
    }
