 ...
 * 加载主密钥
 */
public class ActionLoadMkeyT extends BaseAction {

    public ActionLoadMkeyT() {
        super(GetString.getString(KivviApplication.getContext(),R.string.actionPinpad)+"|"+GetString.getString(KivviApplication.getContext(),R.string.LoadKey)+"|"+GetString.getString(KivviApplication.getContext(),R.string.MKSK)+"|"+GetString.getString(KivviApplication.getContext(),R.string.encrypt_by_TK)+"|"+GetString.getString(KivviApplication.getContext(),R.string.load_master_keyT)+"-2");
...
//        String dbgMK = "D53D201F57B3682A46CE64236B9B4A80";          //明文
        String dbgMK = "4B3ECBE10A5FD02203360D4691FC2F20";            //密文
