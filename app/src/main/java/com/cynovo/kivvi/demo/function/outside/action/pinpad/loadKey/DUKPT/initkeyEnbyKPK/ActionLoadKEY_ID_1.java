 ...
 * authorize
 */
public class ActionLoadKEY_ID_1 extends BaseAction {
    public static boolean DUKPTloaded = false;

    public ActionLoadKEY_ID_1() {
        super(GetString.getString(KivviApplication.getContext(),R.string.actionPinpad)+"|"+ GetString.getString(KivviApplication.getContext(),R.string.LoadKey)+"|"+ GetString.getString(KivviApplication.getContext(),R.string.DUKPT)+"|"+GetString.getString(KivviApplication.getContext(),R.string.initkeyenbykpk)+"|"+ GetString.getString(KivviApplication.getContext(),R.string.Load_init_key)+"(appID1)"+"-7");
    }
...
//        String dbgDMK = "E2EBA521A03142E557F57081B6EFDA35";
//        String dbgKSN = "FFFFF33AE04CB30";
        String dbgDMK = "44A0915D63D28B27E95C9B70CEB63F04";
...
//            kvDevPinpad.Set(KV.KEY.KEY_FORMAT, "plain");
            ...
            if(ret == KV.RET.OK){
                setMsg("(AppID = 1)" + GetString.getString(KivviApplication.getContext(),R.string.success));
            }else{
                String errMsg = "(AppID = 1)加载密钥失败，" + ret + "\n";
                try {
