...
public class ActionCaculateMac extends BaseAction {
    public ActionCaculateMac() {
        super(GetString.getString(KivviApplication.getContext(),R.string.actionPinpad)+"|"+GetString.getString(KivviApplication.getContext(),R.string.calculation_MAC)+"-5");
    }
    ...
    public void myAction(String actionName) {
        ...
        try {
            ...
            for (int str=0;str<macType.length;str++) {
                ...
                kvDev.Set(KV.KEY.PINPAD_CALCULATE_MAC.REQUIRE.KEY_APP_ID, 1);
