...
public class ActionLoadKpk extends BaseAction {
    ...
    public void myAction(String actionName) {
        ...
        try {
            ...
            if(ret == KV.RET.OK){
                setMsg(GetString.getString(KivviApplication.getContext(),R.string.success)+"appId:2");
            }else{
