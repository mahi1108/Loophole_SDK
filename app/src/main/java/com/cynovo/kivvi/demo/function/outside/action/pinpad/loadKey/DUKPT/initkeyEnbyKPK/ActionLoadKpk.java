 ...
 * 加载传输密钥
 */
public class ActionLoadKpk extends BaseAction {

    public ActionLoadKpk() {
        super(GetString.getString(KivviApplication.getContext(),R.string.actionPinpad)+"|"+GetString.getString(KivviApplication.getContext(),R.string.LoadKey)+"|"+GetString.getString(KivviApplication.getContext(),R.string.DUKPT)+"|"+GetString.getString(KivviApplication.getContext(),R.string.initkeyenbykpk)+"|"+GetString.getString(KivviApplication.getContext(),R.string.load_kpk)+"-1");
...
//         String dbgKPK = "23456789012345678901234567843211";
        String dbgKPK = "F28A15802576B9C861CD57BA98D66157";
