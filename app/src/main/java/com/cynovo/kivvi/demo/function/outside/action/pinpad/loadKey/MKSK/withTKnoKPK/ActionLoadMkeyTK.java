 ...
 * 加载主密钥
 */
public class ActionLoadMkeyTK extends BaseAction {

    public ActionLoadMkeyTK() {
        super(GetString.getString(KivviApplication.getContext(),R.string.actionPinpad)+"|"+GetString.getString(KivviApplication.getContext(),R.string.LoadKey)+"|"+GetString.getString(KivviApplication.getContext(),R.string.MKSK)+"|"+GetString.getString(KivviApplication.getContext(),R.string.encrypt_by_TK_noKPK)+"|"+GetString.getString(KivviApplication.getContext(),R.string.load_master_keyTK)+"-1");
    }
    ...
    public void myAction(String actionName) {
        ...
        String dbgMK = "9043B276D365F47CE162DC60FC1CA0EB";
