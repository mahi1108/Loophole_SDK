...
public class ActionDispBalance extends BaseAction {
    ...
    public ActionDispBalance() {
        super(GetString.getString(KivviApplication.getContext(),R.string.actionPinpad)+"|"+GetString.getString(KivviApplication.getContext(),R.string.loadkey_other)+"|"+GetString.getString(KivviApplication.getContext(),R.string.show_balance)+"-2");
    }
