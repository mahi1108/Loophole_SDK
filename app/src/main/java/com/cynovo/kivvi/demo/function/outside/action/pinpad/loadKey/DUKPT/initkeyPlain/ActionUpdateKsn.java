...
public class ActionUpdateKsn extends BaseAction {
    ...
    public ActionUpdateKsn() {
        super(GetString.getString(KivviApplication.getContext(),R.string.actionPinpad)+"|"+ GetString.getString(KivviApplication.getContext(),R.string.LoadKey)+"|"+ GetString.getString(KivviApplication.getContext(),R.string.DUKPT)+"|"+GetString.getString(KivviApplication.getContext(),R.string.initkeyPlain)+"|"+ GetString.getString(KivviApplication.getContext(),R.string.Update_KSN)+"-3");
    }
