 ...
 * 加载工作密钥
 */
public class ActionLoadWkey extends BaseAction {
    public ActionLoadWkey() {
        super(GetString.getString(KivviApplication.getContext(),R.string.actionPinpad)+"|"+GetString.getString(KivviApplication.getContext(),R.string.LoadKey)+"|"+GetString.getString(KivviApplication.getContext(),R.string.MKSK)+"|"+GetString.getString(KivviApplication.getContext(),R.string.MK_SK)+"|"+GetString.getString(KivviApplication.getContext(),R.string.load_work_key)+"-3");
    }

    @Override
    public void myAction(String actionName) {
        LoadWorkKey(PinAppId, "PIN_KEY", "FDAC7B77ECAD14A5C6E11061A8BC9D5F", "52FBEA32");
