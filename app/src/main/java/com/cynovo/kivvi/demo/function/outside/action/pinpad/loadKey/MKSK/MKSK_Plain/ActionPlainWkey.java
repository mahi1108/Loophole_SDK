 ...
 * 明文主密钥加载工作密钥
 */
public class ActionPlainWkey extends BaseAction {
    public ActionPlainWkey() {
        super(GetString.getString(KivviApplication.getContext(),R.string.actionPinpad)+"|"+GetString.getString(KivviApplication.getContext(),R.string.LoadKey)+"|"+GetString.getString(KivviApplication.getContext(),R.string.MKSK)+"|"+GetString.getString(KivviApplication.getContext(),R.string.MKSK_Plain)+"|"+GetString.getString(KivviApplication.getContext(),R.string.Load_Plain_Wkey)+"-2");
    ...
    public void myAction(String actionName) {
        LoadWorkKey(PinAppId, "PIN_KEY", "FDAC7B77ECAD14A5C6E11061A8BC9D5F", "52FBEA32");      //密文

        LoadWorkKey(PinAppId, "TD_KEY", "6FFD18913158B4BD82CBD7CE762C0F62", "C7AB586E");

        LoadWorkKey(PinAppId, "MAC_KEY", "A91CF415667DA4244E9323224D9524BB", "76BC1E41");
    }
}
